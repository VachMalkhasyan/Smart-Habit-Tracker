...
<template>
    <div>
        <div class="p-6 lg:p-8 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
            ...
            <p class="mt-6 text-gray-500 dark:text-gray-400 dark:text-gray-500 leading-relaxed">
        ...
        <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
            <div>
                ...
                <p class="mt-4 text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm leading-relaxed">
